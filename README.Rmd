...
- `vignette("na-column-types")` to see how to handle variable-level missing reasons
...
Due to a [limitation of R](https://vctrs.r-lib.org/#motivation), some base R
functions, like `base::ifelse()` will strip `interlaced` columns into regular vectors:
...
If you run into this, use the tidyverse equivalent of the function that promotes
types properly. In this case,`dplyr::if_else()`:
