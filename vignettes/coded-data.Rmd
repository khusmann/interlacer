...
that obfuscate the meaning of your syntax and results. To facilitate working
...
`v_col_cfactor()` and `na_vol_cfactor()` collector types to load these values
...
Re-coding and writing an interlaced data frame is as simple as calling `as.codes()`
and one of the `write_interlaced_*()` family of functions:
