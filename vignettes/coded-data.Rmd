...
allows you to attached labels to coded data and work with it as a regular
...
The `cfactor` type is an extremely experimental feature and has not been
thoroughly tested yet! I'm sharing them in a super pre-alpha, untested state to
get feedback on them before I invest more time polishing their implementation.
...
`cfactor` vectors can be used as if it was a regular base R `factor`: 
